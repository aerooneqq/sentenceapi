...
namespace SentenceAPI.Features.UserFriends.Services
{
    public class UserFriendsService : IUserFriendsService
    {
        ...
        public async Task AddSubscriber(long userID, long subscriberID)
        {
            try
            {
        ...
        public async Task AddSubscription(long userID, long subscriptionID)
        {
            try
            {
                await mongoDBService.Connect();
        ...
        public async Task DeleteSubscriber(long userID, long subscriberID)
        {
            try
            {
                await mongoDBService.Connect();
        ...
        public async Task DeleteSubscription(long userID, long subscriptionID)
        {
            try
            {
                await mongoDBService.Connect();
        ...
        public async Task<IEnumerable<Subscriber>> GetSubscribers(string token)
        {
            try
            {
                ...
                Models.UserFriends user = (await mongoDBService.Get(
                ...
                foreach (long subscriberID in user.SubscribersID)
                {
        ...
        public async Task<IEnumerable<Subscription>> GetSubscriptions(string token)
        {
            try
            {
                ...
                foreach (long subscriptionID in user.SubscriptionsID)
                {
